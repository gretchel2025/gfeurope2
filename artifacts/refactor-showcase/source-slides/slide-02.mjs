                      ...
                      child: jsxs(Grid, {
                        ...
                        children: [
                          jsx(Text, {
                            ...
                            style: textStyle(`font: 15px Aptos Display; color: ${theme.red}; weight: 700`),
                          }),
                          jsx(Grid, {
                            width: "fill",
                            ...
                            children: [
                              jsx(Panel, {
                                ...
                                child: jsx(Text, {
                                  value: "Route action",
                                  style: textStyle(`font: 14px Aptos Display; color: ${theme.ink}; weight: 700`),
                                  width: "fill",
                                }),
                              }),
                              jsx(Panel, {
                                align: "center",
                                valign: "middle",
                                child: jsx(Shape, { width: 40, height: 4, fill: theme.red, borderRadius: 99 }),
                              }),
                              jsx(Panel, {
                                fill: "#F5E7DA",
                                borderRadius: 16,
