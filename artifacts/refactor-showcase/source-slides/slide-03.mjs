            ...
            children: [
              ...
              jsxs(Grid, {
                ...
                children: [
                  jsx(Grid, {
                    width: "fill",
                    columns: ["fr(1)", "fixed(50)", "fr(1)", "fixed(50)", "fr(1)", "fixed(50)", "fr(1)", "fixed(50)", "fr(1)"],
                    children: [
                      jsx(Panel, {
                        fill: "#E8F1F9",
                        borderRadius: 16,
                        ...
                        child: jsx(Text, {
                          value: "routes",
                          style: textStyle(`font: 16px Aptos Display; color: ${theme.blue}; weight: 700`),
                          width: "fill",
                        }),
                      }),
                      jsx(Panel, { align: "center", valign: "middle", child: jsx(Shape, { width: 42, height: 4, fill: theme.blue, borderRadius: 99 }) }),
                      jsx(Panel, {
                        fill: "#E2F1EE",
                        borderRadius: 16,
                        padding: 12,
                        child: jsx(Text, {
                          value: "server/http",
                          style: textStyle(`font: 16px Aptos Display; color: ${theme.teal}; weight: 700`),
                          width: "fill",
                        }),
                      }),
                      jsx(Panel, { align: "center", valign: "middle", child: jsx(Shape, { width: 42, height: 4, fill: theme.teal, borderRadius: 99 }) }),
                      jsx(Panel, {
                        fill: "#E7EEF9",
                        borderRadius: 16,
                        padding: 12,
                      ...
                      jsx(Panel, { align: "center", valign: "middle", child: jsx(Shape, { width: 42, height: 4, fill: theme.green, borderRadius: 99 }) }),
                      jsx(Panel, {
                        fill: "#EFEAF8",
                        borderRadius: 16,
                        padding: 12,
                      ...
                      jsx(Panel, { align: "center", valign: "middle", child: jsx(Shape, { width: 42, height: 4, fill: theme.warm, borderRadius: 99 }) }),
                      jsx(Panel, {
                        fill: "#F4EFE8",
                        borderRadius: 16,
                        padding: 12,
                        child: jsx(Text, {
                          ...
                          style: textStyle(`font: 16px Aptos Display; color: ${theme.warmDark}; weight: 700`),
                          width: "fill",
                        }),
                      }),
                    ],
