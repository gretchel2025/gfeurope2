...
const eventDetailsById: Record<string, EmailEventDetails> = {
	...
	jewels2026: {
		...
		time: [
			...
			'10:30 AM Morning Socials',
			'11:00 AM Conference Begins',
			'11:30 AM Talk 1: Rooted in Faith',
			"12:30 PM Talk 2: Mary's Yes: Lesson in Surrender, Trust, and Obedience",
			'1:15 PM Lunch',
			'2:30 PM Stories of Becoming',
			'3:45 PM Girl Talk and Afternoon Tea',
			'4:20 PM Talk 3: Bloom with Purpose',
			'5:40 PM Conference Ends',
