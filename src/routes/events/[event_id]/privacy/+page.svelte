...
<LegalPage
	...
	intro="This Privacy Policy describes how we collect, use, and disclose your information when you use the service, and it explains your privacy rights."
	introSecondary="We use personal data to provide and improve the service. By using the service, you agree to the collection and use of information in accordance with this policy."
	companionHref={publicNav.conditions}
	companionLabel="View Terms and Conditions"
>
	...
	<p>
		...
		our Cookies Policy or the cookies section of this Privacy Policy.
	</p>
	...
	<ul>
		<li>
			...
			to monitor and analyze the use of our Service, and to contact You.
		</li>
		<li>
	...
	<div class="mt-10 border-t border-white/10 pt-6 text-sm text-[#fff3df]/70">
		<p>
			Looking for the rules that govern use of the site? Review our
			<a href={publicNav.conditions}>Terms and Conditions</a>.
		</p>
	</div>
</LegalPage>
