...
>
	...
	<ul>
		...
		<li>
			<p>
				<strong>Terms and Conditions</strong> (also referred to as &quot;Terms&quot;) mean these Terms
		...
		<li>
			<p>
				<strong>Website</strong> refers to The Feast Europe (referred to as either &quot;We&quot;,
				&quot;Us&quot;, &quot;Our&quot;, or &quot;Company&quot; in this Agreement), accessible from
	...
	<p>
		...
		with the <a href={publicNav.privacy}>Privacy Policy</a> of the Company. Our Privacy Policy describes
		Our policies and procedures on the collection, use and disclosure of Your personal information when
		You use the Application or the Website and tells You about Your privacy rights and how the law protects
	...
	<ul>
		<li>
			By visiting our contact page: <a
				href="https://grandfeast.eu/contact"
				rel="external nofollow noopener"
				target="_blank">grandfeast.eu/contact</a
			>
		</li>
	</ul>
	<div class="mt-10 border-t border-white/10 pt-6 text-sm text-[#fff3df]/70">
		<p>
			...
			<a href={publicNav.privacy}>Privacy Policy</a>.
		</p>
	</div>
</LegalPage>
